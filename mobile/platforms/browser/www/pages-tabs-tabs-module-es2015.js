...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'search',
                loadChildren: () => __webpack_require__.e(/*! import() | Search-search-module */ "Search-search-module").then(__webpack_require__.bind(null, /*! ../Search/search.module */ "./src/app/pages/Search/search.module.ts")).then(m => m.SearchModule)
            },
            {
                path: 'cart',
                loadChildren: () => __webpack_require__.e(/*! import() | Cart-cart-module */ "Cart-cart-module").then(__webpack_require__.bind(null, /*! ../Cart/cart.module */ "./src/app/pages/Cart/cart.module.ts")).then(m => m.CartModule)
            },
            {
                path: 'profile',
                loadChildren: () => __webpack_require__.e(/*! import() | Profile-profile-module */ "Profile-profile-module").then(__webpack_require__.bind(null, /*! ../Profile/profile.module */ "./src/app/pages/Profile/profile.module.ts")).then(m => m.ProfileModule)
            },
            {
                path: '',
